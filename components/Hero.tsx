   ...
   <div>
      <div className="max-w-3xl xl:max-w-4xl 2xl:max-w-5xl 2xl:mt-20 mx-auto px-4 py-8 md:py-16 flex flex-col md:flex-row items-center md:space-y-0 md:space-x-8 mt-12 max-md:mt-6">
        ...
        <div className="w-full md:w-1/2">
          ...
          I started my programming adventure in October 2022. I am a second year Information of Technology student, aspiring to become a <span className='text-primary'>Full Stack Developer</span>.
          </p>
        </div>
      </div>
